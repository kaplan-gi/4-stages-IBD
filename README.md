...
- Data: A 10% random subset of our data has been supplied for reproducibility, a more complete dataset will be available upon publication.
...
Weighted mean incidence and prevalence as well as Annual Average Percent Change (AAPC) measures were calculated to summarize the dataset and describe the epidemiology at either a study-level or a region-level. A classic meta-analysis grouped by epidemiologic stage was performed to determine pooled rates across the available studies.
